Action()
{
	...
	web_url("ALL", 
		"URL=http://lr-training:8080/#/catalog/api/v1/DemoAppConfig/parameters/by_tool/ALL", 
		"Resource=0", 
	...
	web_custom_request("GetAccountConfigurationRequest", 
		"URL=http://lr-training:8080/#//accountservice/ws/GetAccountConfigurationRequest", 
		"Method=POST", 
		"Resource=0", 
	...
	web_url("categories", 
		"URL=http://lr-training:8080/#/catalog/api/v1/categories", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://lr-training:8080/#/", 
		"Snapshot=t5.inf", 
	...
	web_url("search", 
		"URL=http://lr-training:8080/#/catalog/api/v1/deals/search?dealOfTheDay=true", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://lr-training:8080/#/", 
		"Snapshot=t6.inf", 
	...
	web_url("popularProducts.json", 
		"URL=http://lr-training:8080/#/app/tempFiles/popularProducts.json", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://lr-training:8080/#/", 
		"Snapshot=t7.inf", 
	...
	web_url("products",
		"URL=http://lr-training:8080/#/catalog/api/v1/categories/5/products", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://lr-training:8080/#/", 
		"Snapshot=t9.inf", 
	...
	web_url("attributes", 
		"URL=http://lr-training:8080/#/catalog/api/v1/categories/attributes", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://lr-training:8080/#/", 
		"Snapshot=t10.inf", 
	...
	web_url("27", 
		"URL=http://lr-training:8080/#/catalog/api/v1/products/27", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://lr-training:8080/#/", 
		"Snapshot=t12.inf", 
	...
	web_url("all_data", 
		"URL=http://lr-training:8080/#/catalog/api/v1/categories/all_data", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://lr-training:8080/#/", 
		"Snapshot=t13.inf", 
